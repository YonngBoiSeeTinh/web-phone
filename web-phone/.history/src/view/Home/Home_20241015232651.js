...
function Home ({filter}){
        ...
        const fetchApi = async () => {
          ...
          const filteredListProducts = [
            { promo: "giamgia", color: ["#cc5333", "#c94b4b"] },
            { promo: "moi", color: ["#cc5333", "#c94b4b"] },
            { promo: "tragop", color: ["#cc5333", "#c94b4b"] },
          ];
        ...
        return (
            ...
            <div className="home-container">
                ...
                <div className="contain-khungSanPham" style={{ display: filter ? 'block' : 'none' }}>
                   <ProductListSearch filter ={filter}  color={['#42bcf4', '#004c70']} listPro ={filterList} />   
                </div>
