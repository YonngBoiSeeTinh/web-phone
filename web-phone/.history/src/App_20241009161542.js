...
import AdminUserPage from './view/Admin/User/CustomerPage'
...
import Order from './view/Admin/Order/OrderPaid';
...
const [filter, setFilter] = useState("");
  return (
    <div className="App">
      {!isAdminPage && <Header isSignIn={isSignIn} setIsSignIn={setIsSignIn} setFilter={setFilter}/>} {/* Hiển thị Header nếu không phải trang admin */}
      {!isAdminPage && <TopNavigation />} {/* Hiển thị TopNavigation nếu không phải trang admin */}
        ...
        <Routes>
          ...
          <Route path='/employeeOrder' element={<Order />} />
