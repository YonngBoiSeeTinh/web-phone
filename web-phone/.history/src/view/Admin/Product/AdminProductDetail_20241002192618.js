...
function ProductDetail() {
    ...
    const [product, setProduct] = useState(query.data);
    ...
    return (
        <div className="product-container">
            ...
            <ProductUpdateForm product={product} imageLink={imageLink} />
        </div>
    );
}
    ...
    return (
        <div className="options">
            <div className="color-options">
                ...
                <button className="add-color-button" onClick={handleAddColorClick}>
                    Thêm màu
                </button>
            </div>
            ...
            {isDialogOpen && (
                <div className="dialog">
                    <div className="dialog-content">
                        <div>
                            <label>Màu: </label>
                            <input type="text" value={selectedColor.color} />
                        </div>
                        <div>
                            <label>Mã màu: </label>
                            <input type="text" value={selectedColor.code} />
                        </div>
                        <div>
                            <label>Số lượng: </label>
                            <input type="number" value={selectedColor.count} />
                        </div>
            ...
            {isDialogAddOpen && (
                <div className="dialog">
                    <div className="dialog-content">
                        ...
                        <div>
                            <label>Mã màu: </label>
                            <input type="text" value={newColorCode} onChange={(e) => setNewColorCode(e.target.value)} />
                        </div>
                        <div>
                            <label>Số lượng: </label>
                            <input type="number" value={newColorCount} onChange={(e) => setNewColorCount(e.target.value)} />
                        </div>
                        <button className="dialog-add-button">Thêm màu</button>
                        <button className="dialog-close-button" onClick={handleDialogAddClose}>Đóng</button>
                    </div>
                </div>
            )}
        </div>
