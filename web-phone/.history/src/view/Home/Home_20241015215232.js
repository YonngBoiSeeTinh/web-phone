...
function Home ({filter}){
        ...
        const fetchApi = async () => {
          ...
          const [seeAllList, setSeeAll] = useState([]);
        ...
        return (
            <section>
                ...
                <div className="contain-khungSanPham" style={{ display: filter && seeAllList.length >0? 'none' : 'block' }}>

                    <HomeProductList tenKhung="NỔI BẬT NHẤT" color={['#42bcf4', '#004c70']}  len={4} listPro ={listPro} setSeeAll={setSeeAll}/>
                    <HomeProductList tenKhung="GIẢM GIÁ LỚN" color={['#ff9c00', '#ec1f1f']}  len={4} listPro ={filterGiamGia()} setSeeAll={setSeeAll} />  
                    <HomeProductList tenKhung="SẢN PHẨM MỚI" color={['#42bcf4', '#004c70']}  len={4} listPro ={filterMoiRaMat()} setSeeAll={setSeeAll}/>
                    <HomeProductList tenKhung="TRẢ GÓP 0%" color={['#141e30', '#2c3e50']} len={4} listPro ={filterTraGop()} setSeeAll={setSeeAll}/>      
                </div>

                <div className="contain-khungSanPham" style={{ display: filter && !seeAllList? 'block' : 'none' }}>

                    <HomeProductList  tenKhung={`Kết quả tìm kiếm cho: ${filter}`}  color={['#42bcf4', '#004c70']}  len={4} listPro ={filterList} />
                   
                </div>

                <div className="contain-khungSanPham" style={{ display: seeAllList? 'block' : 'none' }}>

                    <HomeProductList  tenKhung={``}  color={['#42bcf4', '#004c70']}  len={8} listPro ={seeAllList} />
