        ...
        return (
            <section>
                ...
                <div className="contain-khungSanPham">
                    <HomeProductList tenKhung="NỔI BẬT NHẤT" color={['#42bcf4', '#004c70']}  len={5} listPro ={listPro} />
                    <HomeProductList tenKhung="GIẢM GIÁ LỚN" color={['#ff9c00', '#ec1f1f']}  len={5} listPro ={filterGiamGia()}  />  
                    <HomeProductList tenKhung="SẢN PHẨM MỚI" color={['#42bcf4', '#004c70']}  len={5} listPro ={filterMoiRaMat()} />
                    <HomeProductList tenKhung="TRẢ GÓP 0%" color={['#141e30', '#2c3e50']} len={5} listPro ={filterTraGop()} />      
                </div>
            </div>
            </section>
