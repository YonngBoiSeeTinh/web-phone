  ...
  return (
    <div className="cart-container">
      ...
      {listCart.map((cart, index) => (
        <CartItem cart={cart} key={index} handleSelectedCart={handleSelectedCart} totalPrice={totalPrice} setTotalPrice={setTotalPrice}/>
      ))}
      ...
      <form className="cart-form">
        ...
        <button type="submit" className="submit-button" onClick={handleOrder}>Đặt hàng</button>
      </form>
    </div>
  );
};
