    ...
    <div className="cart-container">
      ...
      <div className="cart-form">
        <div className="customer-info">     
          <input type="text" placeholder="Họ và Tên"  onChange={(e) => setUserName(e.target.value)} />
          <input type="text" placeholder="Số điện thoại" onChange={(e) => setPhone(e.target.value)}  />
          <input type="text" placeholder="Số nhà, tên đường" onChange={(e) => setAddress(e.target.value)}/>
        </div>
