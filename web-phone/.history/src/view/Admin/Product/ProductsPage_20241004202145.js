...
const ProductsPage = () => {
    ...
    return (
      <div className="admin-product-container">
         <form className="input-search" method="get" action="index.html" style={{margin:'10px auto'}}>
                            <div className="autocomplete" style={{width:'700px'}>
                                <input id="search-box" name="search" autoComplete="off" type="text" placeholder="Nhập từ khóa tìm kiếm..." style={{width:'00px'}}/>
                                <button type="submit">
