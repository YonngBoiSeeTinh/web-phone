    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                setUser((prev) => ({
                    ...prev,
                    avatar: imageUrl // Cập nhật đường dẫn hình ảnh vào sản phẩm
                }));
            };
            ...
            <div className="user-page">
                <div className="user-profile">
                    ...
                    <div className="product-gallery" onClick={() => document.getElementById('fileInput').click()}>
                        <img src={imageLink ? imageLink : "https://cdn-icons-png.flaticon.com/512/4211/4211763.png"} alt="avatar" className="user-avatar" />
                    </div>
