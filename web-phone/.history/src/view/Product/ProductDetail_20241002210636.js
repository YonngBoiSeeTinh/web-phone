...
function ProductDetail() {
    ...
    return (
        <div className="product-container">
            ...
            <ProductInfo product={product} handleColorClick ={handleColorClick} />
        </div>
    );
