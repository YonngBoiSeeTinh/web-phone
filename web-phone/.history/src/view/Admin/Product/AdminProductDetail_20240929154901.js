            ...
            <div className="color-options">
                {colors.map((colorItem, index) => (
                    <div 
                        ...
                        onClick={() => handleAddColorClick()} // Gọi hàm khi click vào màu
                    >
                    </div>
                ))}
                <div className="btn-add_color"  onClick={() => handleColorClick(null)} >Thêm</div>
            </div>

            {/* Dialog chỉ được render một lần bên ngoài vòng lặp */}
            {isDialogOpen && (
                <div className="dialog-color" >
                    <div className="dialog_color-content" style={{display:'block'}}>
                        ...
                        <input type="text" placeholder="Nhập mã màu" defaultValue={selectedColor.code} /> <br></br>
             ...
             {isDialogAddOpen && (
                <div className="dialog-color" >
                    <div className="dialog_color-content" style={{display:'block'}}>
                        <p >Thêm màu</p>
                        <p>Mã màu: </p>
                        <input type="text" placeholder="Nhập mã màu" defaultValue="#"/> <br></br>
                        <input type="number" placeholder="Nhập số lượng" />
                        <div style={{display:'flex'}}> 
                            <div className="btn btnOK">OK</div>
                            <div   className="btn btnCancle" onClick={handleAddColorClick}>Đóng</div>
                         </div>
