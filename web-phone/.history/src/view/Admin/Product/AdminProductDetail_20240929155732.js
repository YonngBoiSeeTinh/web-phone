...
function ProductUpdateForm({ product }) {
    ...
    const handleUpdate = async (e) => {
        console.log("Updated Product:", updatedProduct); // Kiểm tra dữ liệu
        e.preventDefault();
        try {
            const response = await axios.put(`http://localhost:3001/api/product/update/${product.id}`, updatedProduct);
