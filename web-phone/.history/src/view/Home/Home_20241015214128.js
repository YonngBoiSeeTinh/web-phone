...
function Home ({filter}){
        ...
        return (
            <section>
                ...
                <div className="contain-khungSanPham" style={{ display: filterList? 'none' : 'block' }}>

                    <HomeProductList tenKhung="NỔI BẬT NHẤT" color={['#42bcf4', '#004c70']}  len={4} listPro ={listPro} setFilterList={setFilterList}/>
                    <HomeProductList tenKhung="GIẢM GIÁ LỚN" color={['#ff9c00', '#ec1f1f']}  len={4} listPro ={filterGiamGia()} setFilterList={setFilterList} />  
                    <HomeProductList tenKhung="SẢN PHẨM MỚI" color={['#42bcf4', '#004c70']}  len={4} listPro ={filterMoiRaMat()} setFilterList={setFilterList}/>
                    <HomeProductList tenKhung="TRẢ GÓP 0%" color={['#141e30', '#2c3e50']} len={4} listPro ={filterTraGop()} setFilterList={setFilterList}/>      
                </div>

                <div className="contain-khungSanPham" style={{ display: filterList? 'block' : 'none' }}>
