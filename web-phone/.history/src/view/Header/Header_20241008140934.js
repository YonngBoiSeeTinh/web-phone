...
const Header = ({isSignIn,setIsSignIn}) => {
    ...
    const handleClickCard =()=>{
        if (!user.id) {
            ...
            navigate('/employeeCard'); // Điều hướng đến trang employeeCard nếu user là employee
        } else {
            navigate('/cart'); // Điều hướng đến trang cart cho user khác
        }
            ...
            <div className="header group">
                ...
                <div className="content">
                    ...
                    <div className="tools-member">
                        ...
                        <div className="cart">
                            <Link to={user.id ? "/cart" : "#"} onClick={handleClickCard}>
