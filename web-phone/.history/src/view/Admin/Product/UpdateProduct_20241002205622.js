...
function ProductUpdateForm({ product, imageLink,setProduct }) {
    ...
    const details = [
        ...
        { key: "Camera sau", name: "camera", value: updatedProduct.detail?.camara || "Không có thông tin" },
        { key: "Camera trước",  name: "cameraFront",value: updatedProduct.detail?.camaraFront || "Không có thông tin" },
